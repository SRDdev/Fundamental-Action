...
from utils.gemini_oop_object_detection import *
from TrajectoryNet_Inference import *
            ...
            while True:
                ...
                if key & 0xFF == ord('q'):
                    ...
                    if rgb_path and depth_path:
                        ...
                        real_coords1 = self.process_coordinates(coords1, depth_image)
                        if real_coords1:
                        ...
                        real_coords2 = self.process_coordinates(coords2, depth_image)
                        if real_coords2:
...
if __name__ == "__main__":
    ...
    class_names = ["soda can", "robotic arm"]
